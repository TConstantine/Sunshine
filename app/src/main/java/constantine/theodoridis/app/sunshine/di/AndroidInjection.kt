...
class AndroidInjection {
	companion object {
		fun inject(target: ForecastFragment, view: ForecastsContract.View) {
			DaggerForecastsComponent.builder()
							.activityModule(ActivityModule(target.context!!))
							.forecastsModule(ForecastsModule(view))
