...
@AndroidEntryPoint
class ForecastsFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor>,
  ...
  @Inject
  lateinit var presenter: MapLocationPresenter
  ...
  override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
    inflater.inflate(R.menu.forecasts_menu, menu)
  }
  ...
  override fun onInflate(context: Context, attrs: AttributeSet, savedInstanceState: Bundle?) {
    ...
    val a = activity!!.obtainStyledAttributes(attrs, R.styleable.ForecastsFragment,
      0, 0)
    mChoiceMode = a.getInt(R.styleable.ForecastsFragment_android_choiceMode, AbsListView.CHOICE_MODE_NONE)
    mAutoSelectView = a.getBoolean(R.styleable.ForecastsFragment_autoSelectView, false)
    mHoldForTransition = a.getBoolean(R.styleable.ForecastsFragment_sharedElementTransitions, false)
    a.recycle()
  }
  ...
  override fun onActivityCreated(savedInstanceState: Bundle?) {
    presenter.mapLocation().observe(viewLifecycleOwner, Observer { displayMapLocation(it) })
    presenter.mapLocationError().observe(viewLifecycleOwner, Observer { displayInvalidLocationError() })
