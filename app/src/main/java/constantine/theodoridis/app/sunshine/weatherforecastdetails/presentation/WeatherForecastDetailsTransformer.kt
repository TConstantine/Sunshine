...
class WeatherForecastDetailsTransformer : Transformer<LoadWeatherForecastDetailsResponse, WeatherForecastDetailsViewModel> {
	...
	private fun transformTemperatureDescription(temperatureDescriptionLabel: String, transformedTemperature: String): String {
